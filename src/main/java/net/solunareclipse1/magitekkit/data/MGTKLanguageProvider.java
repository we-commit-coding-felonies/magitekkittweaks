...
public class MGTKLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("tip.mgtk.arcana.guide.2.4.alt", "Shrink");
        ...
        add("tip.mgtk.arcana.guide.3.3", "Haste");
        add("tip.mgtk.arcana.guide.3.3.alt", "Haste");
        ...
        add("tip.mgtk.arcana.guide.6.3", "Smart arrows");
        add("tip.mgtk.arcana.guide.6.3.alt", "Smart arrows");
        add("tip.mgtk.arcana.guide.6.4", "Summon / control Sentient Arrow");
        add("tip.mgtk.arcana.guide.6.4.alt", "Summon / control Sentient Arrow");
        ...
        add("tip.mgtk.arcana.guide.7.3", "Create thunderstorm");
        add("tip.mgtk.arcana.guide.7.3.alt", "Create thunderstorm");
        add("tip.mgtk.arcana.guide.7.4", "Smite nearby");
        add("tip.mgtk.arcana.guide.7.4.alt", "Smite nearby");
        add("tip.mgtk.arcana.guide.8.1", "Freeze");
        add("tip.mgtk.arcana.guide.8.1.alt", "Freeze");
        add("tip.mgtk.arcana.guide.8.2", "Extinguish nearby");
        add("tip.mgtk.arcana.guide.8.2.alt", "Extinguish nearby");
        ...
        add("tip.mgtk.arcana.guide.9.1", "De-fuse explosive");
